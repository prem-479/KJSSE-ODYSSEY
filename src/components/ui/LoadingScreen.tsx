...
export default function LoadingScreen() {
    ...
    // Dedicated Three.js Space Background
    useEffect(() => {
        ...
        async function init() {
            ...
            const NEBULA_CLOUD_COUNT = 80;
            const nebHues = [
                new THREE!.Color(0x0a1128),
                new THREE!.Color(0x1a0b2e),
                new THREE!.Color(0x081c15),
                new THREE!.Color(0x14213d),
    ...
    return (
        <motion.div
            ...
            style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(0,0,0,0)", backdropFilter: "blur(0px)" }}
        >
            <div style={{ position: "absolute", inset: 0, zIndex: -1, background: "#000000", pointerEvents: "none", overflow: "hidden" }}>
                <canvas
                    ref={canvasRef}
